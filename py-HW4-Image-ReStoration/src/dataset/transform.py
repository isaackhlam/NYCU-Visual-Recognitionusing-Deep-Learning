...
def get_degraded_transform():
    return A.OneOf([
        ...
        A.OneOf([
            ...
            A.RandomSnow(snow_point_lower=0.2, snow_point_upper=0.4, brightness_coeff=1.8, p=1.0),
            A.RandomSnow(snow_point_lower=0.3, snow_point_upper=0.5, brightness_coeff=1.5, p=1.0),
        ], p=1.0),
    ], p=1.0)
